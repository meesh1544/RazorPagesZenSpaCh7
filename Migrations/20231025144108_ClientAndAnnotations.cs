    ...
    public partial class ClientAndAnnotations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 10, 25, 10, 41, 8, 155, DateTimeKind.Local).AddTicks(4097), 1 },
                    { 2, 2, new DateTime(2023, 10, 25, 10, 41, 8, 155, DateTimeKind.Local).AddTicks(4142), 7 },
                    { 3, 1, new DateTime(2023, 10, 25, 10, 41, 8, 155, DateTimeKind.Local).AddTicks(4145), 5 }
                });
