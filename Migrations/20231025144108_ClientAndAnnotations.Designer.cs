...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20231025144108_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2023, 10, 25, 10, 41, 8, 155, DateTimeKind.Local).AddTicks(4097),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2023, 10, 25, 10, 41, 8, 155, DateTimeKind.Local).AddTicks(4142),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2023, 10, 25, 10, 41, 8, 155, DateTimeKind.Local).AddTicks(4145),
                            ServicesID = 5
                        });
                });
